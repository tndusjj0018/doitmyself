...
CREATE SEQUENCE RECENT_VIEW_SEQ;
...
CREATE TABLE SUB_CATEGORY_TBL(
	SC_NO		NUMBER(4)		PRIMARY KEY,
	SC_NAME	VARCHAR2(20)		NOT NULL,
	SC_NO_REF NUMBER(4)			REFERENCES CATEGORY_TBL(C_NO) 	ON DELETE CASCADE
);
...
CREATE TABLE SELLER_TBL(
	...
	SELLER_ID		VARCHAR2(20)		REFERENCES USER_TBL(USER_ID) ON DELETE CASCADE			NOT NULL,
	SELLER_ADDRESS	VARCHAR2(100)																NOT NULL,
	SELLER_POSTCODE	VARCHAR2(30)																NOT NULL,
	SELLER_B_NUM VARCHAR2(30)		
);
...
CREATE TABLE PRODUCT_TBL(
	...
	P_SELLER		VARCHAR2(30)	REFERENCES SELLER_TBL(SELLER_NAME) ON DELETE CASCADE		NOT NULL, 	
...
CREATE TABLE IMG_TBL(
	...
	IMG_P_NO	NUMBER			REFERENCES PRODUCT_TBL(P_NO)	ON DELETE CASCADE	NOT NULL,
...
CREATE TABLE QNA_TBL(
	...
	QNA_P_NO		NUMBER				REFERENCES PRODUCT_TBL(P_NO)		ON DELETE CASCADE		NOT NULL,
	QNA_SUBJECT		VARCHAR2(100)																	NOT NULL,
	QNA_CONTENT		VARCHAR2(1000)																	NOT NULL,
	QNA_WRITER		VARCHAR2(20)		REFERENCES USER_TBL(USER_ID)		ON DELETE CASCADE		NOT NULL,
	...
	QNA_ISRESPONSE	NUMBER(1)			DEFAULT 0	CHECK(QNA_ISRESPONSE IN(0,1)) 					NOT NULL,
	QNA_ANSWER VARCHAR2(450)
);

<!-- 찜 테이블 -->
CREATE TABLE DIBS_TBL(
	D_NO		NUMBER			  															PRIMARY KEY,
	D_P_NO		NUMBER				REFERENCES PRODUCT_TBL(P_NO)	ON DELETE CASCADE		NOT NULL,
	D_USER_ID	VARCHAR2(20)		REFERENCES USER_TBL(USER_ID)	ON DELETE CASCADE		NOT NULL
);
...
CREATE TABLE ORDER_TBL(
	...
	ORDER_P_NO		NUMBER			REFERENCES PRODUCT_TBL(P_NO)					ON DELETE CASCADE	NOT NULL,
	...
	ORDER_ID		VARCHAR2(20)	REFERENCES USER_TBL(USER_ID)					ON DELETE CASCADE	NOT NULL,
	ORDER_CATEGORY	NUMBER(4)														NOT NULL,
...
CREATE TABLE REVIEW_TBL(
	...
	REVIEW_WRITER	VARCHAR2(20)	REFERENCES USER_TBL(USER_ID)	ON DELETE CASCADE	NOT NULL,
	REVIEW_P_NO		NUMBER			REFERENCES PRODUCT_TBL(P_NO)	ON DELETE CASCADE	NOT NULL,
	REVIEW_IMG		VARCHAR2(40),
	REVIEW_ORDER_NO NUMBER	NOT NULL
);


<!--최근 본 상품 테이블-->
CREATE TABLE RECENT_VIEW_TBL(
	RV_ID		VARCHAR2(30)	REFERENCES USER_TBL(USER_ID)		ON DELETE CASCADE	NOT NULL,
	RV_P_NO		NUMBER			REFERENCES PRODUCT_TBL(P_NO)		ON DELETE CASCADE	NOT NULL,
...
CREATE TABLE CART_TBL(
	...
	CART_ID			VARCHAR2(20)	REFERENCES USER_TBL(USER_ID)	ON DELETE CASCADE	NOT NULL,
	CART_P_NO		NUMBER			REFERENCES PRODUCT_TBL(P_NO)	ON DELETE CASCADE	NOT NULL,
	CART_COUNT		NUMBER(2)															NOT NULL
);
...
CREATE TABLE SECURITY_NO_TBL(
	SN_NO		NUMBER(6),
	SN_ID		VARCHAR2(20)		REFERENCES USER_TBL(USER_ID)	ON DELETE CASCADE	PRIMARY KEY
);
...
CREATE TABLE REFUND_TBL(
	REFUND_NO		NUMBER		REFERENCES PRODUCT_TBL(P_NO)		ON DELETE CASCADE	NOT NULL,
	REFUND_P_NO		NUMBER		REFERENCES ORDER_TBL(ORDER_NO)		ON DELETE CASCADE	NOT NULL,
