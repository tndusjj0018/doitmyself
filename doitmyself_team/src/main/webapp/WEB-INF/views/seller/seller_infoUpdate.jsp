                ...
                <form action="sellerInfoUpdate" method="post">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>사업지 주소</label>
                        <input type="text" class="form-control" placeholder="seller_address" id="seller_address" name="SELLER_ADDRESS" required>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label for="exampleInputEmail1">사업자번호</label>
                        <input type="text" class="form-control" placeholder="seller_b_num" id="seller_b_num" name="SELLER_B_NUM" required>
                      </div>
                    </div>
                  </div>
