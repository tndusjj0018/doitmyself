		...
		<tbody>
			...
			<tr>
				...
				<td><input name="QNA_SUBJECT" id="subject" type="text"
					size="10" maxlength="100" class="form-control" placeholder="제목 입력"></td>
			<tr>
				<td>내용</td>
				<td><textarea name="QNA_CONTENT" id="content" style="resize: none;"></textarea>	<!-- 사이즈 484 / 96 -->	
			</tr>
			<tr>
			<td>비밀글 여부</td>
				<td><label><input type="checkbox" name="QNA_SECRET" id="secretCHK"
					value="0">비밀글로 문의하기</label></td>
					</tr>
			</tbody>
		</table>
		<div id="buttons">
